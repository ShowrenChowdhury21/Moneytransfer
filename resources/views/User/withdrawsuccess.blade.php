                            ...
                            <div class="col-md-8 col-lg-8 mx-auto ">
                                ...
                                <div class="bg-light shadow-md rounded p-3 p-sm-4 mb-4 form-box">
                                    <div class="text-center my-5">
                                        ...
                                        <p class="text-center text-4">Withdraw Request Succesfully Sent</p>
                                    </div>
                                    <button class="btn btn-default btn-center btn-block"  onclick="location.href='/user/withdraw';"><span class="bh"></span><span>Withdraw Money Again</span></button>
                                </div>
