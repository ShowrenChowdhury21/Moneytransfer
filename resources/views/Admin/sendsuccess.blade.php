                   ...
                   <div class="col-md-8 col-lg-6 col-xl-5 mx-auto">
                     ...
                     <div class="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
                        <div class="text-center my-5">
                            <p class="text-center text-success text-20 line-height-07"><i class="fa fa-check-circle" style="font-size: 80px;"></i></p>
                            <p class="text-center text-success text-8 line-height-07">Success!</p>
                            <p class="text-center text-4">Transactions Complete</p>
                        </div>
                       <button class="btn btn-primary btn-block" onclick="location.href='/admin/sendmoney';">Send Money Again</button>
                     </div>
                   </div>
                 </div>
               </div>
