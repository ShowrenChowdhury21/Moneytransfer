              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                 <div class="breadcrumb text-center">
                    <div class="section-headline white-headline text-center">
                       <h3>Join Us Now</h3>
                       <p style="color:#fff;">Your Sign Up information is safe with us.</p>
                    </div>
                 </div>
              </div>
           </div>
          ...
          <div class="row">
            <div class="card" style="margin-top: 50px;">
              ...
              <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <form id="signupForm" method="post" class="log-form" action="{{ route('auth.signupprocess') }}">
                @csrf
                ...
                @endif
                  <div class="form-group">
                    <label for="fullName" style="font-family: Sans-serif;">Full Name</label>
                    <input type="text" class="form-control input-lg" id="fullName" name='name' required placeholder="Enter Your Name">
                    <span class="text-danger">@error('name'){{$message}}@enderror</span>
                  </div>
                  <div class="form-group">
                    <label for="emailAddress" style="font-family: Sans-serif;">Email Address</label>
                    <input type="email" class="form-control input-lg" id="emailAddress" name="email" required placeholder="Enter Your Email">
                  ...
                  <div class="row">
                      <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <div class="input">
                                <select id="select2" name="country" class="form-select">
                      ...
                      <div class="col-xs-6">
                        <div class="form-group">
                            <label for="currency" style="font-family: Sans-serif;">Currency</label>
                            <div class="input">
                                <select class="form-select" id="select1" name="currency" required style="width: 120px">
                                    <option data-subtext="United States dollar" selected="selected" value="USD">USD</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control input-lg" id="password" name="password" required placeholder="Enter Password">
                    <span class="text-danger">@error('password'){{$message}}@enderror</span>
                  </div>
                  <div class="form-group">
                    <label for="loginPassword" style="font-family: Sans-serif;">Confirm Password</label>
                    <input type="password" class="form-control input-lg" id="confirmpassword" name="confirmpassword" required placeholder="Enter Password">
                  ...
                  <button class="btn btn-primary btn-block my-4" style="font-size: 20px;" type="submit" id="submit">Sign Up</button>
                </form>
              </div>
            </div>
          </div>
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="banner-all area-80 text-center">
                     <div class="banner-content">
                        ...
                        <a class="banner-btn" href="/login">Sign In</a>
                     </div>
                  </div>
               </div>
            </div>
