              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                 <div class="breadcrumb text-center">
                    <div class="section-headline white-headline text-center">
                       ...
                       <p style="color:#fff;">No worries. We're here to help.</p>
                    </div>
                 </div>
              </div>
           </div>
          ...
          <div class="row">
            <div class="card" style="margin-top: 50px;">
              <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <form id="resetform" method="post" action="{{ route('auth.resetpasswordprocess',['email'=>$email,'token' => $token]) }}">
                 @csrf
                 ...
                 @endif
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control input-lg" id="emailAddress" name="email" value="{{ $email ?? old('email') }}" required>
                    <span class="text-danger">@error('email'){{$message}}@enderror</span>
                  </div>
                  <div class="form-group">
                    <label for="emailAddress">New Password</label>
                    <input type="password" class="form-control input-lg" id="password" name="password" required placeholder="Enter New Password" required>
                    <span class="text-danger">@error('password'){{$message}}@enderror</span>
                  </div>
                  <div class="form-group">
                    <label for="emailAddress">Confirm Address</label>
                    <input type="password" class="form-control input-lg" id="password" name="confirmpassword" required placeholder="Enter New Password" required>
